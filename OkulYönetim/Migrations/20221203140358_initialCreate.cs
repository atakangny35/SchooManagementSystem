        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserDersId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserDers_Dersler_Dersid",
                        column: x => x.Dersid,
                        principalTable: "Dersler",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserDers_Users_Userid",
                        column: x => x.Userid,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDers_Dersid",
                table: "UserDers",
                column: "Dersid");

            migrationBuilder.CreateIndex(
                name: "IX_UserDers_Userid",
                table: "UserDers",
                column: "Userid");
